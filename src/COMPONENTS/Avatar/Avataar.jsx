...
const Avataar = () => {
    ...
    function onDrawerOpenandClose() {
        ...
        if (open.current) {
            ...
            avtr.style.transform = `translate(${drwr.offsetLeft + avtrIndrwr.offsetLeft - avtr.offsetLeft -7}px,${avtrIndrwr.offsetTop + drwr.offsetTop - avtr.offsetTop - 7}px) scale(${2},${2})`;
