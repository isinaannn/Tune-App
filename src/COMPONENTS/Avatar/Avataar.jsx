...
const Avataar = ({Drawer}) => {
    ...
    return (
        <div className="avtranddrwr" key={"1"}>
            <Avatar className="avtr" name="Aravindan J"size={40} src={url} maxInitials={2} style={{
                
            }} round onClick={onDrawerOpenandClose} />
            <Drawer closeDrawer={onDrawerOpenandClose}/>
