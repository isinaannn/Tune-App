    ...
    return (
        <div className="Buttons-container">
            ...
            <div className="shuffle-btn">
                <svg className='shuffle-icon' fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" id="shuffle" x="0" y="0" version="1.1" viewBox="0 0 50 50">
            ...
            <div className="share-btn">
                <svg className='share-icon' fill='#FFFFFF' xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="512" height="512" id="share"
                    viewBox="0 0 512 512">
            ...
            <div className="menu-btn">
                <svg className='menu-icon' fill='#FFFFFF' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="menu">
